...
<head>
    ...
    <title>انفوجرافيك: الخيوط السحرية التي تربط العالم بسرعة الضوء</title>
    <!-- Chosen Palette: Brilliant Blues (from colour combinations image) -->
    <!-- Application Structure Plan: تم تصميم التطبيق كهيكل تفاعلي من صفحة واحدة، مقسمة إلى أقسام رئيسية للدورة التدريبية، وكل محاضرة ضمن قسم قابل للطي (details/summary). يركز الهيكل على عرض المحتوى النظري، الأهداف السلوكية، الأنشطة التفاعلية، والمهام التطبيقية لكل محاضرة بشكل منظم. كما يتضمن أقسامًا رئيسية لعرض بنية الدورة، صندوق الأدوات، قياس النجاح، تحليل التحديات، والآفاق المستقبلية. هذا الهيكل يعكس تمامًا التنظيم الجديد للحقيبة التدريبية ويوفر تجربة تعلم منظمة وتفاعلية، مع الحفاظ على تصميم عصري وجذاب. -->
    <!-- Visualization & Content Choices:
        - مخطط دائري (Doughnut Chart) لتوزيع الوقت (Chart.js): الهدف: إبلاغ بنسبة.
        - مخطط شريطي (Bar Chart) لمستوى التفاعل مع الأدوات (Chart.js): الهدف: مقارنة كمية.
        - مخطط شريطي مكدس (Stacked Bar Chart) لتحديات الفهم (Chart.js): الهدف: إظهار تركيبة وتوزيع.
        - مخطط راداري (Radar Chart) لإمكانات التقنيات المستقبلية (Chart.js): الهدف: مقارنة متعددة الأبعاد.
        - مخطط شريطي (Bar Chart) لمقارنة الألياف بالنحاس (Chart.js): الهدف: مقارنة كمية واضحة (المحاضرة 1).
        - محاكاة حركة الضوء في الليف (HTML/CSS/JS): الهدف: إظهار التغيير بصريًا (المحاضرة 2).
        - تبويبات للمقارنة بين أنواع الألياف (HTML/CSS/JS): الهدف: تنظيم ومقارنة المعلومات (المحاضرة 2).
        - مطابقة المكونات والوظائف (HTML/CSS): نشاط تصوري (المحاضرة 3).
        - مخطط عظم السمكة (Ishikawa Diagram) الثابت (HTML/CSS): الهدف: تنظيم الأسباب والنتائج بشكل هرمي (المحاضرة 5).
        - جميع الفيديوهات المذكورة في الأنشطة تم استبدالها باقتراحات للبحث على YouTube لضمان العمل.
        - تم استخدام HTML/CSS/JS فقط للرسوم البيانية والرسومات التخطيطية لتجنب SVG/Mermaid JS.
    -->
    ...
    <style>
        ...
        .fishbone-category-line.top-2 { top: -20px; left: 45%; transform: rotate(-30deg); }
...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="container mx-auto p-4 md:p-8">
        ...
        <main class="space-y-24">
            ...
            <!-- المحاضرة الثانية: الانعكاس الكلي الداخلي (سحر الضوء المحبوس) -->
            ...
            <!-- المحاضرة الثالثة: بناء شبكة الضوء (مكونات النظام البصري) -->
            ...
            <section id="lec4" class="py-16 bg-white rounded-xl shadow-lg">
                ...
                <details open class="mb-6 bg-blue-50 p-4 rounded-lg">
                    ...
                    <div class="p-2 text-gray-700">
                        ...
                        <ul class="list-disc pr-5">
                            <li><strong>الإضاءة والديكور:</strong> إضاءة الأماكن الصعبة الوصول، تصميمات إضاءة مبتكرة.</li>
            ...
            <!-- المحاضرة الخامسة: تحديات ومستقبل الألياف البصرية (آفاق أخلاقية وعلمية) -->
            ...
            <!-- المحاضرة السادسة: تقنية DWDM (ثورة السعة الضوئية) -->
        ...
        <footer class="text-center mt-24 border-t pt-8 border-gray-200">
            ...
            <p class="text-gray-500 mt-4">تم إنشاء هذا الانفوجرافيك لتوضيح محتويات حقيبة "الخيوط السحرية" التدريبية.</p>
        </footer>
    ...
    <script>
        ...
        // Chart for Challenges (Stacked Bar)
